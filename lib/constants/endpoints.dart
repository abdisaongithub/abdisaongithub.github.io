...
class OrderEndpoint {
  ...
  static String getUserActiveOrders(String userId) =>
      '$base?CustomerId=$userId&IsOpen=true';
}
...
class UserEndpoint {
  ...
  static String userAddressByAddressId(String addressId) =>
      '$base/address/$addressId';
